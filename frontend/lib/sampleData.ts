...
export const SAMPLE_PICKS: DailyStockPick[] = [
  {
    ...
    backtest_summary: { percentile_rank: 97, sharpe_ratio: 1.42, n_periods: 126 },
    status: "PENDING",
    decided_at: null,
    decided_by: null,
  },
  {
    ...
    backtest_summary: { percentile_rank: 89, sharpe_ratio: 1.15, n_periods: 126 },
    status: "PENDING",
    decided_at: null,
    decided_by: null,
  },
  {
    ...
    backtest_summary: { percentile_rank: 81, sharpe_ratio: 0.98, n_periods: 126 },
    status: "PENDING",
    decided_at: null,
    decided_by: null,
  },
  {
    ...
    backtest_summary: { percentile_rank: 93, sharpe_ratio: 1.28, n_periods: 126 },
    status: "APPROVED",
